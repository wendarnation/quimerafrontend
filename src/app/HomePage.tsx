      ...
      <main className="pb-12">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">{user ? 'Create wishlists and track your favorite sneakers' : 'Sign up to save your favorite sneakers'}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">Browse thousands of sneakers from top brands</p>
            <button
